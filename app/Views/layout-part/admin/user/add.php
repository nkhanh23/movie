...
<section id="add-user-view" class="content-section active" style="padding: 30px;">
    <div class="page-header">
        ...
        <button onclick="window.location.href='<?php echo _HOST_URL; ?>/admin/user'" id="btn-cancel-user" class="btn"><i
                class="fa-solid fa-arrow-left"></i> Quay lại danh sách</button>
    </div>
            ...
            <div class="form-group">
                ...
                <select name="status_id" id="status_id">
                    ...
                    <?php foreach ($getAllUserStatus as $item): ?>
                        <option value="<?php echo $item['id']; ?>"
                            <?php echo (!empty($oldData['status_id']) && $oldData['status_id'] == $item['id']) ? 'selected' : '' ?>>
                            <?php echo $item['name']; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
