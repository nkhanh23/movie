...
<div class="min-h-screen selection:bg-secondary/30 selection:text-white relative">
    ...
    <div class="relative h-[60vh] sm:h-[70vh] md:h-[95vh] w-full flex items-center overflow-hidden group transition-all duration-500">
        ...
        <div class="relative z-10 px-4 md:px-12 w-full max-w-5xl mt-16 sm:mt-24 md:mt-32 flex flex-col justify-center h-full pb-8 sm:pb-12">
            ...
            <p id="heroDesc" class="hidden sm:block text-sm sm:text-base md:text-lg text-gray-200 mb-4 sm:mb-8 drop-shadow-md line-clamp-2 sm:line-clamp-3 max-w-2xl leading-relaxed"><?php echo $heroFirst['description']; ?></p>
    ...
    <div class="relative z-20 -mt-8 sm:-mt-16 md:-mt-24 pb-12 sm:pb-20 space-y-6 sm:space-y-8">
        ...
        <?php if (!empty($getContinueWatching)): ?>
            <div class="relative z-20 px-3 sm:px-4 md:px-12 pt-8 sm:pt-16 pb-6 sm:pb-10 group/continue section-continue">
                                            ...
                                            <div class="flex items-center justify-between text-xs text-gray-400">
                                                ...
                                                <?php if ($isSeriesEpisode): ?>
                                                    <span class="truncate pr-2">
                                                        Tập <?php echo !empty($item['episode_name']) ? $item['episode_name'] : '1'; ?>
                                                        <?php if (!empty($item['season_name'])): ?>
                                                            <span class="mx-1">•</span><?php echo $item['season_name']; ?>
                                                        <?php endif; ?>
                                                    </span>
                                                <?php else: ?>
        ...
        <!-- Horror section  -->
        <div class="cards-row px-3 sm:px-4 md:px-12 cards-slide wide section-horror pt-16 sm:pt-24 md:pt-32">
