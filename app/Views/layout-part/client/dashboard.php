...
<body class="bg-background-dark text-white font-display antialiased min-h-screen selection:bg-secondary/30 selection:text-white relative">
    ...
    <div class="relative h-[80vh] md:h-[95vh] w-full flex items-center overflow-hidden group transition-all duration-500">
        ...
        <div class="relative z-10 px-4 md:px-12 w-full max-w-5xl mt-32 flex flex-col justify-center h-full pb-12">
            ...
            <div class="flex gap-4">
                ...
                <button id="heroFav"
                    class="group/fav flex items-center gap-3 px-8 py-3.5 rounded-full font-bold text-white transition-all duration-300 transform hover:scale-105 bg-white/10 hover:bg-white/20 border border-white/20 backdrop-blur-md js-favorite-btn <?= $favClass ?>"
    ...
    <div class="relative z-20 -mt-24 pb-20 space-y-8">
        ...
        <div class="max-w-[1900px] md:px-12 px-5 mx-auto my-12 mb-52 md:mb-64"> <!-- Increased mb to accommodate absolute thumbnails -->
            ...
            <div class="relative w-full group/anime-section">
                ...
                <div id="anime-main-display" class="relative w-full h-[400px] md:h-[500px] rounded-xl overflow-hidden shadow-2xl bg-background-dark/80">
