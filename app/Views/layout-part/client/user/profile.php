                ...
                <main class="flex-1 layout-content-container flex flex-col gap-6">
                    ...
                    <div class="px-2 py-2">
                        <div class="flex flex-col gap-2">
                            <h2 class="text-white text-2xl lg:text-3xl font-bold tracking-tight drop-shadow-lg">Thông Tin Cá Nhân</h2>
                    ...
                    <div class="user-glassmorphic rounded-2xl p-8 relative overflow-hidden group">
                        ...
                        <div class="relative z-10 flex w-full flex-col gap-8 md:flex-row md:justify-between md:items-center">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                                <button onclick="window.location.href='<?php echo _HOST_URL; ?>/tai-khoan/chinh-sua'" class="kinetic-hover flex items-center justify-center gap-2 px-6 py-2.5 rounded-lg border border-white/10 bg-white/5 text-white text-sm font-semibold tracking-wide hover:shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-all">
                                    <span class="material-symbols-outlined text-[18px] text-slate-300">edit</span>
                                    Chỉnh sửa
                                </button>
                                <button onclick="window.location.href='<?php echo _HOST_URL; ?>/tai-khoan/bao-mat'" class="kinetic-hover flex items-center justify-center gap-2 px-6 py-2.5 rounded-lg bg-primary/20 border border-primary/40 text-white text-sm font-semibold tracking-wide hover:bg-primary/30 hover:shadow-[0_0_15px_rgba(217,108,22,0.3)] transition-all">
