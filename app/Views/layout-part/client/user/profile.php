                    ...
                    <div class="user-glassmorphic rounded-2xl p-8 relative overflow-hidden group">
                        ...
                        <div class="relative z-10 flex w-full flex-col gap-8 md:flex-row md:justify-between md:items-center">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                                <button class="kinetic-hover flex items-center justify-center gap-2 px-6 py-2.5 rounded-lg border border-white/10 bg-white/5 text-white text-sm font-semibold tracking-wide hover:shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-all">
